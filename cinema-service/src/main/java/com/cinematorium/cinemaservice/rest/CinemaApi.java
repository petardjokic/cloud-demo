...
public class CinemaApi {
	...
	public CinemaApi(CinemaService cinemaService, HallService hallService, SeatService seatService, ProjectionService projectionService) {
	...
	public List<ProjectionEager> getProjections(@PathVariable Long cinemaId) {
		return projectionService.getByCinemaId(cinemaId);
	}
